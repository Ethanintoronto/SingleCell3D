...
void Simulation::Run(){
    ...
    for (int i=0;i<numTimesteps_;i++){
        update();
        std::cout<<"Iteration: "<<time_<<std::endl;
        std::cout<<"Fx: "<< cells_[0]->getVertices()[0]->getForce()[0]<<" Fy: "<<cells_[0]->getVertices()[0]->getForce()[1]<<" Fz: "<<cells_[0]->getVertices()[0]->getForce()[2]<<std::endl;
        std::cout<<"Fx: "<< cells_[0]->getVertices()[1]->getForce()[0]<<" Fy: "<<cells_[0]->getVertices()[1]->getForce()[1]<<" Fz: "<<cells_[0]->getVertices()[1]->getForce()[2]<<std::endl;
        std::cout<<"Fx: "<< cells_[0]->getVertices()[2]->getForce()[0]<<" Fy: "<<cells_[0]->getVertices()[2]->getForce()[1]<<" Fz: "<<cells_[0]->getVertices()[2]->getForce()[2]<<std::endl;
        std::cout<<"Fx: "<< cells_[0]->getVertices()[3]->getForce()[0]<<" Fy: "<<cells_[0]->getVertices()[3]->getForce()[1]<<" Fz: "<<cells_[0]->getVertices()[3]->getForce()[2]<<std::endl;
        std::cout<<"Fx: "<< cells_[0]->getVertices()[4]->getForce()[0]<<" Fy: "<<cells_[0]->getVertices()[4]->getForce()[1]<<" Fz: "<<cells_[0]->getVertices()[4]->getForce()[2]<<std::endl;
        std::cout<<"Fx: "<< cells_[0]->getVertices()[5]->getForce()[0]<<" Fy: "<<cells_[0]->getVertices()[5]->getForce()[1]<<" Fz: "<<cells_[0]->getVertices()[5]->getForce()[2]<<std::endl;
